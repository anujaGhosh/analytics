...
fitted(fit2)#predicted value
omni$sales#actual value
#difference of above two gives residual
a=residuals(fit2)
summary(a)
...
#Assumptions
par(mfrow=c(2,2))#draw all plots in one area
plot(fit2)
...
omni[-c(11,14,15),]#removing these values

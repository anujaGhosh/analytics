...
#subset3----
inspect(subset(rules, subset=items %ain% c("whole milk","yogurt") & confidence >.95))#either of the items, %ain%
...
inspect(subset(rules, subset= lhs %pin% "bread" & rhs %in% "whole milk" & confidence > .9))#pin=partial
